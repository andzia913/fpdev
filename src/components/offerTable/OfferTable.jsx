...
import useFlatsData from '../../utils/dataService.jsx';
    ...
    <div className="table-container">
      <div className="table-container__filters">
        ...
        <div>
          ...
          <input
            ...
            max={100}
            min={30}
            onChange={(e) => setSurfaceInputMin(e.target.value)}
          />
          do:
          <input
            className="table-filter"
            ...
            max={100}
            min={40}
            onChange={(e) => setSurfaceInputMax(e.target.value)}
          />
        </div>
        <div>
          <p>Cena </p>
      ...
      <div className="offer-container__table-pagination">
        <div>
          ...
          {pageOptions.map((el, index) => <button type="button" key={index} className={`${pageIndex === el ? 'active-page' : ''}`} onClick={() => gotoPage(el)}>{el + 1}</button>)}
          <button
            type="button"
            onClick={() => nextPage()}
